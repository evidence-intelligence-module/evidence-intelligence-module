...
**Derived from [`hld.md`](../../../documents/hld.md) §5 — not an independent contract.** If the two ever disagree, `hld.md` is authoritative and this file is stale and needs re-syncing, not the other way around.
